...
HD_PWD='C:/Users/magzm/YODA_Vivado/ASG_YODA/ASG_YODA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ASG_Core.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ASG_Core.tcl
