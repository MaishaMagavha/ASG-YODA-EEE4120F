...
HD_PWD='C:/Users/magzm/YODA_Vivado/ASG_YODA/ASG_YODA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ASG_Core.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ASG_Core.tcl -notrace
